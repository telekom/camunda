...
final class ProcessInstanceElementActivatingV4Applier
  ...
  /**
   * Decides whether to increment the element activation counter for loop detection.
   *
   * <p>Mirrors the logic in BpmnStreamProcessor.shouldCheckLoopDetection to ensure consistent
   * counting:
   *
   * <ul>
   *   <li><b>Sequential MULTI_INSTANCE_BODY</b>: skip. The body shares its counter with its
   *       sequential children to avoid stealing slots from the children's count.
   *   <li><b>Parallel MULTI_INSTANCE_BODY</b>: count.
   *   <li><b>Sequential MI children</b>: count.
   *   <li><b>Parallel MI children</b>: skip.
   * </ul>
   */
