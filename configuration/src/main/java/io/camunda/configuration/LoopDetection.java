...
public class LoopDetection {
   ...
   * the incident before a new one is raised.
   */
   ...
   *
   * <pre>
   * camunda.processing.engine.loop-detection.max-element-activation-count-by-type:
   *   SERVICE_TASK: 500
   *   EXCLUSIVE_GATEWAY: 5000
   *   USER_TASK: 0   # disabled
   * </pre>
   */
